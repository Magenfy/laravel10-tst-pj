...
<footer id="footer">
    <div class="site-footer px-6 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-300 py-4 ltr:ml-[248px] rtl:mr-[248px]">
        ...
        <div class="text-center ltr:md:text-start rtl:md:text-right text-sm">
            {{ __('COPYRIGHT') }} © <script>  document.write(new Date().getFullYear())</script> {{ __('Laravel Tailwind CSS, Todos os Direitos Reservados') }}
        </div>
        <div class="ltr:md:text-right rtl:md:text-end text-center text-sm">
            {{ __('Design & Develop by') }}
            <a href="https://adrocket.com.br" target="_blank" class="text-primary-500 font-semibold">
            {{ __('Laravel Full Stack') }}
            </a>
        </div>
        </div>
    </div>
